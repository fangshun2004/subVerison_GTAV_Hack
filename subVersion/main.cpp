					...
					int			nCmdShow)
{
	...
	addFeature(-1, unlock, L"解锁末日豪劫车辆批发价（需要购买对应房产）", feat_btn, &hack::unlockDoomsdayHeistCars, -1.f);
	addFeature(-1, unlock, L"解锁CEO特殊车辆批发价（需要购买对应房产）", feat_btn, &hack::unlockCeoCars, -1.f);
	addFeature(-1, unlock, L"解锁军火走私车辆批发价（需要购买对应房产）", feat_btn, &hack::unlockAsCars, -1.f);
	addFeature(-1, unlock, L"解锁飞机批发价（需要购买对应房产）", feat_btn, &hack::unlockPlane, -1.f);
	addFeature(-1, unlock, L"解锁赌场豪劫载具批发价", feat_btn, &hack::unlockCasinoHeistCars, -1.f);
